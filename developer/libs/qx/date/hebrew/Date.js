define([
    ...
    "dojo/_base/declare",
    "./numerals"
], function (config, declare, numerals) {
	return declare("qx.date.hebrew.Date", [], {
		...
		//
		// example:
		// |	dojo.require("qx.date.hebrew.Date");
		// |
		...
		*/
		...
		constructor: function () {
			...
			// |
			// |		var date2 = new qx.date.hebrew.Date(date1);
			// |
			// |		var date3 = new qx.date.hebrew.Date(5768,2,12);
		...
		getDateLocalized: function (/*String?*/locale) {
			...
			return (locale || config.locale).match(/^he(?:-.+)?$/) ?
		...
		getMonth: function () {
			...
			//
			// example:
			// |		var date1 = new qx.date.hebrew.Date(5769, 6, 1);
			// |
		...
		fromGregorian: function (/*Date*/gdate) {
			...
			// example:
			// |		var dateHebrew = new qx.date.hebrew.Date();
		...
		toGregorian: function () {
			...
			// example:
			// |		var dateHebrew = new qx.date.hebrew.Date(5768,11,20);
