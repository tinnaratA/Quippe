define([
	...
	"dojo/string",
	"./Date",
	"dojo/i18n!dojo/cldr/nls/buddhist"
], function (lang, arr, dd, i18n, regexp, string, BDate) {

	var blocale = lang.getObject("qx.date.buddhist.locale", true);
		...
		return pattern.replace(/([a-z])\1*/ig, function (match) {
			...
			switch (c) {
				...
				case 'Z':
					...
					break;
				default:
					throw new Error("qx.date.buddhist.locale.formatPattern: invalid pattern char: " + pattern);
			}
	...
	blocale.format = function (/*qx/Calendars/Buddhist/Date*/dateObject, /*object?*/options) {
		// summary:
	...
	blocale.getNames = function (/*String*/item, /*String*/type, /*String?*/context, /*String?*/locale, /*qx/Calendars/Buddhist/Date?*/date) {
		// summary:
