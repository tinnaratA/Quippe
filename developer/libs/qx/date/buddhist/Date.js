define([
	...
	var BDate = declare("qx.date.buddhist.Date", null, {
		...
		constructor: function () {
			...
			// example:
			//	|	var date1 = new qx.date.buddhist.Date();
			//	|	var date2 = new qx.date.buddhist.Date(date1);
			//	|	var date3 = new qx.date.buddhist.Date(2552,2,12);
