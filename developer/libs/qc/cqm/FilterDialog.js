define([
	...
	"dojo/on",
    "dojo/query",
    "dojo/text!qc/cqm/templates/FilterDialog.htm",
    "dojo/topic",
    "qc/_core"
	...
	return declare("qc.cqm.FilterDialog", [TooltipDialog, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        getSettingName: function (propertyName) {
            return 'cqmReviewFilter' + propertyName.charAt(0).toUpperCase() + propertyName.substr(1);
        },
